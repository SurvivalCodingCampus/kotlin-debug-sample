...
class YukymController {
    ...
    fun getTyB(): String {
        ...
        when {
            ...
            nowTime.hour >= 14 && nowTime.hour < 16 -> return timeDataOne.first().ty7
            nowTime.hour >= 16 && nowTime.hour < 18 -> return timeDataOne.first().ty8
            nowTime.hour >= 18 && nowTime.hour < 20 -> return timeDataOne.first().ty9
            nowTime.hour >= 20 && nowTime.hour < 22 -> return timeDataOne.first().ty10
            nowTime.hour >= 22 && nowTime.hour < 24 -> return timeDataOne.first().ty11
        }
